<template>
  <div class="flex flex-col gap-6 text-white mt-6">
    <!-- Page Heading -->
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <article class="bg-gray-900/90 border border-neon-cyan/12 rounded-lg p-4 flex flex-col gap-1.5">
        <header class="text-xs uppercase text-gray-400/80 tracking-wider">Items publicados</header>
      ...
      <!-- Destacados Card -->
      <article class="bg-gray-900/90 border border-neon-cyan/12 rounded-lg p-4 flex flex-col gap-1.5">
        <header class="text-xs uppercase text-gray-400/80 tracking-wider">Destacados</header>
      ...
      <!-- Inactivos Card -->
      <article class="bg-gray-900/90 border border-neon-cyan/12 rounded-lg p-4 flex flex-col gap-1.5">
        <header class="text-xs uppercase text-gray-400/80 tracking-wider">Inactivos</header>
      ...
      <!-- Categorías Card -->
      <article class="bg-gray-900/90 border border-neon-cyan/12 rounded-lg p-4 flex flex-col gap-1.5">
        <header class="text-xs uppercase text-gray-400/80 tracking-wider">Categorías</header>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <!-- Latest Items Panel -->
      <section class="bg-gray-900/92 border border-neon-cyan/10 rounded-xl p-5 flex flex-col gap-3">
        ...
        <!-- Table -->
        <div v-if="latestItems.length" class="border border-neon-cyan/8 rounded-xl overflow-hidden">
          <table class="w-full border-collapse text-sm">
            <thead class="bg-neon-cyan/8 uppercase tracking-wider">
              <tr>
                <th class="py-2 px-4 text-left font-semibold text-gray-400/85">Título</th>
                <th class="py-2 px-4 text-left font-semibold text-gray-400/85">Categoría</th>
                <th class="py-2 px-4 text-left font-semibold text-gray-400/85">Estado</th>
                <th class="py-2 px-4 text-left font-semibold text-gray-400/85">Actualizado</th>
              </tr>
            </thead>
            <tbody>
              <tr
        ...
        <p v-else class="text-sm text-gray-400/80 p-6 rounded-lg bg-gray-900/80 border border-dashed border-neon-cyan/15">
    ...
    <!-- Quick Actions Panel -->
    <section class="bg-gray-900/92 border border-neon-cyan/10 rounded-xl p-5 flex flex-col gap-4">
